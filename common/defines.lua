...
country = {
	...
	INVESTMENT_SCORE_FACTOR = 0.0010, -- how much foreign investment money counts towards your industry score
	...
	NEWSPAPER_PRINTING_FREQUENCY = 365000, -- days frequency when the news attempt to be printed (may not print if not enough facts collected, and retry after another X days)
	NEWSPAPER_TIMEOUT_PERIOD = 365000, -- the max period for news that may be printed. The probability is decreased with time.
	NEWSPAPER_MAX_TENSION = 36000, -- when tension of printing gets this high, the newspaper will attempt to be printed immediately.
	...
	COLONIZATION_INTEREST_COST_INITIAL = 800,
	COLONIZATION_INTEREST_COST_NEIGHBOR_MODIFIER = -200,
	...
	COLONIZATION_CREATE_COLONY_COST = 0, -- per province
	...
	MAX_RESEARCH_POINTS = 1, -- max RP you can store for uncivs
},
...
military = {
	...
	SUPPLY_RANGE = 250,
	POP_MIN_SIZE_FOR_REGIMENT_PROTECTORATE_MULTIPLIER = 5,
	...
	AI_ARMY_TAXBASE_FRACTION = 0.7, -- max of tax base that AI will spend on army supply (0 = no cap; 0.35 = limits overspend, fewer bankruptcies)
	AI_NAVY_TAXBASE_FRACTION = 0.7, -- max of tax base that AI will spend on navy supply (limits overspend)
...
diplomacy = {
	...
	GIVEMILACCESS_RELATION_ON_ACCEPT = 25,
	...
	REMOVEFROMSPHERE_INFAMY_COST = 2, -- only applied if removing country is sphere leader
	...
	TWS_GRACE_PERIOD_DAYS = 1825, -- Ticking War Score delay before it starts falling down for not fulfilling CB.
	...
	LONE_BACKER_PRESTIGE_FACTOR = 0.00 -- prestige boost for being only defender backer in crisis
}, 
...
ai =
{
	...
	ADMINISTRATOR_WEIGHT = 28.0, -- ai weight for new bureaucrat (higher = more NFs on bureaucrats, better admin)
	INDUSTRYWORKER_WEIGHT = 15.0, -- ai weight for new industry workers (higher = more focus on industry)
	EDUCATOR_WEIGHT = 80.0, -- ai weight for new clergy (higher = more NFs on clergy, faster literacy)
	SOLDIER_WEIGHT = 35.0, -- ai weight for soldiers
	SOLDIER_FRACTION = 0.04, -- max amount of population AI wants to be soldiers
	CAPITALIST_FRACTION = 0.006, -- max amount of population AI wants to be capis (higher = more factory building)
	PRODUCTION_WEIGHT = 3, -- ai weight for new production (higher = AI prioritizes industry NFs)
	SPAM_PENALTY = 90, -- makes certain diplomatic action less common 
	ONE_SIDE_MAX_WARSCORE = 100, -- don't add too many wargoals to one side in a war
	POP_PROJECT_INVESTMENT_MAX_BUDGET_FACTOR = 0.60, -- how much % of budget AI can spend on pop project investments
	...
	CHANCE_BUILD_NAVAL_BASE = 0.35, -- higher = AI builds more naval bases (better supply)
	CHANCE_BUILD_FORT = 0,
	CHANCE_INVEST_POP_PROJ = 0.12, -- chance AI invests in pop projects (was 0 = never; now sometimes)
	CHANCE_FOREIGN_INVEST = 0.06, -- chance AI does foreign investment (was 0 = never)
	...
	MONTHS_BEFORE_DISBAND = 100000, -- Months from start date before AI will disband armies/navies (to avoid disbands because of early economic turmoil)
},
